...
echo "Building the Flutter web app with base href /fishwise/..."
flutter build web --release --base-href="/fishwise/" #change '/myappRepo/' to the name of the github repo of your project
